...
export declare namespace bigtableadmin_v2 {
    ...
    export class Resource$Projects$Instances$Clusters$Backups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        copy(params: Params$Resource$Projects$Instances$Clusters$Backups$Copy, options: StreamMethodOptions): GaxiosPromise<Readable>;
        copy(params?: Params$Resource$Projects$Instances$Clusters$Backups$Copy, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
    ...
    export class Resource$Projects$Instances$Clusters$Hottablets {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Instances$Clusters$Hottablets$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Instances$Clusters$Hottablets$List, options?: MethodOptions): GaxiosPromise<Schema$ListHotTabletsResponse>;
    ...
    export class Resource$Projects$Instances$Tables {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Instances$Tables$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Projects$Instances$Tables$Patch, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        undelete(params: Params$Resource$Projects$Instances$Tables$Undelete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        undelete(params?: Params$Resource$Projects$Instances$Tables$Undelete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
