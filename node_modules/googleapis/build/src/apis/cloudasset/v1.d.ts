...
export declare namespace cloudasset_v1 {
    ...
    export class Resource$V1 {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        analyzeOrgPolicies(params: Params$Resource$V1$Analyzeorgpolicies, options: StreamMethodOptions): GaxiosPromise<Readable>;
        analyzeOrgPolicies(params?: Params$Resource$V1$Analyzeorgpolicies, options?: MethodOptions): GaxiosPromise<Schema$AnalyzeOrgPoliciesResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        analyzeOrgPolicyGovernedAssets(params: Params$Resource$V1$Analyzeorgpolicygovernedassets, options: StreamMethodOptions): GaxiosPromise<Readable>;
        analyzeOrgPolicyGovernedAssets(params?: Params$Resource$V1$Analyzeorgpolicygovernedassets, options?: MethodOptions): GaxiosPromise<Schema$AnalyzeOrgPolicyGovernedAssetsResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        analyzeOrgPolicyGovernedContainers(params: Params$Resource$V1$Analyzeorgpolicygovernedcontainers, options: StreamMethodOptions): GaxiosPromise<Readable>;
        analyzeOrgPolicyGovernedContainers(params?: Params$Resource$V1$Analyzeorgpolicygovernedcontainers, options?: MethodOptions): GaxiosPromise<Schema$AnalyzeOrgPolicyGovernedContainersResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        queryAssets(params: Params$Resource$V1$Queryassets, options: StreamMethodOptions): GaxiosPromise<Readable>;
        queryAssets(params?: Params$Resource$V1$Queryassets, options?: MethodOptions): GaxiosPromise<Schema$QueryAssetsResponse>;
