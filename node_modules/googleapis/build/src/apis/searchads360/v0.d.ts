...
export declare namespace searchads360_v0 {
    ...
    export class Resource$Customers$Searchads360 {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        searchStream(params: Params$Resource$Customers$Searchads360$Searchstream, options: StreamMethodOptions): GaxiosPromise<Readable>;
        searchStream(params?: Params$Resource$Customers$Searchads360$Searchstream, options?: MethodOptions): GaxiosPromise<Schema$GoogleAdsSearchads360V0Services__SearchSearchAds360StreamResponse>;
        searchStream(params: Params$Resource$Customers$Searchads360$Searchstream, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        searchStream(params: Params$Resource$Customers$Searchads360$Searchstream, options: MethodOptions | BodyResponseCallback<Schema$GoogleAdsSearchads360V0Services__SearchSearchAds360StreamResponse>, callback: BodyResponseCallback<Schema$GoogleAdsSearchads360V0Services__SearchSearchAds360StreamResponse>): void;
        searchStream(params: Params$Resource$Customers$Searchads360$Searchstream, callback: BodyResponseCallback<Schema$GoogleAdsSearchads360V0Services__SearchSearchAds360StreamResponse>): void;
        searchStream(callback: BodyResponseCallback<Schema$GoogleAdsSearchads360V0Services__SearchSearchAds360StreamResponse>): void;
    }
    ...
    export interface Params$Resource$Customers$Searchads360$Searchstream extends StandardParameters {
        /**
         * Required. The ID of the customer being queried.
         */
        customerId?: string;
