...
(function (retail_v2alpha) {
    ...
    class Resource$Projects$Locations$Catalogs$Attributesconfig {
        ...
        batchRemoveCatalogAttributes(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v2alpha/{+attributesConfig}:batchRemoveCatalogAttributes').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['attributesConfig'],
    ...
    class Resource$Projects$Locations$Catalogs$Branches {
        constructor(context) {
            ...
            this.places = new Resource$Projects$Locations$Catalogs$Branches$Places(this.context);
            this.products =
    ...
    class Resource$Projects$Locations$Catalogs$Branches$Places {
        constructor(context) {
            this.context = context;
            this.operations =
                new Resource$Projects$Locations$Catalogs$Branches$Places$Operations(this.context);
        }
    }
    retail_v2alpha.Resource$Projects$Locations$Catalogs$Branches$Places = Resource$Projects$Locations$Catalogs$Branches$Places;
    class Resource$Projects$Locations$Catalogs$Branches$Places$Operations {
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
    ...
    retail_v2alpha.Resource$Projects$Locations$Catalogs$Branches$Places$Operations = Resource$Projects$Locations$Catalogs$Branches$Places$Operations;
    class Resource$Projects$Locations$Catalogs$Branches$Products {
        ...
        purge(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2alpha/{+parent}/products:purge').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['parent'],
    ...
    class Resource$Projects$Locations$Catalogs$Models {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2alpha/{+parent}/models').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['parent'],
        ...
        pause(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2alpha/{+name}:pause').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['name'],
        ...
        resume(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2alpha/{+name}:resume').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['name'],
        ...
        tune(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2alpha/{+name}:tune').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['name'],
    ...
    retail_v2alpha.Resource$Projects$Locations$Catalogs$Models = Resource$Projects$Locations$Catalogs$Models;
