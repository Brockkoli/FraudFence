...
export declare namespace kmsinventory_v1 {
    ...
    export class Resource$Organizations$Protectedresources {
         ...
         */
        search(params: Params$Resource$Organizations$Protectedresources$Search, options: StreamMethodOptions): GaxiosPromise<Readable>;
        search(params?: Params$Resource$Organizations$Protectedresources$Search, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudKmsInventoryV1SearchProtectedResourcesResponse>;
    ...
    export class Resource$Projects$Cryptokeys {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Cryptokeys$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Cryptokeys$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudKmsInventoryV1ListCryptoKeysResponse>;
    ...
    export class Resource$Projects$Locations$Keyrings$Cryptokeys {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getProtectedResourcesSummary(params: Params$Resource$Projects$Locations$Keyrings$Cryptokeys$Getprotectedresourcessummary, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getProtectedResourcesSummary(params?: Params$Resource$Projects$Locations$Keyrings$Cryptokeys$Getprotectedresourcessummary, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudKmsInventoryV1ProtectedResourcesSummary>;
