...
export declare namespace appengine_v1beta {
    ...
    export class Resource$Projects$Locations$Applications {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Applications$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Projects$Locations$Applications$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Applications$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Applications$Get, options?: MethodOptions): GaxiosPromise<Schema$Application>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        repair(params: Params$Resource$Projects$Locations$Applications$Repair, options: StreamMethodOptions): GaxiosPromise<Readable>;
        repair(params?: Params$Resource$Projects$Locations$Applications$Repair, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        repair(params: Params$Resource$Projects$Locations$Applications$Repair, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        repair(params: Params$Resource$Projects$Locations$Applications$Repair, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        repair(params: Params$Resource$Projects$Locations$Applications$Repair, callback: BodyResponseCallback<Schema$Operation>): void;
        repair(callback: BodyResponseCallback<Schema$Operation>): void;
    }
    ...
    export interface Params$Resource$Projects$Locations$Applications$Repair extends StandardParameters {
        /**
         * Part of `name`. See documentation of `projectsId`.
         */
        applicationsId?: string;
