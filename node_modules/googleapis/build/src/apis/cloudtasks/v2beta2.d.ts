...
export declare namespace cloudtasks_v2beta2 {
    ...
    export class Resource$Api$Queue {
         ...
         */
        update(params: Params$Resource$Api$Queue$Update, options: StreamMethodOptions): GaxiosPromise<Readable>;
        update(params?: Params$Resource$Api$Queue$Update, options?: MethodOptions): GaxiosPromise<Schema$Empty>;
    ...
    export class Resource$Projects$Locations$Queues$Tasks {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        buffer(params: Params$Resource$Projects$Locations$Queues$Tasks$Buffer, options: StreamMethodOptions): GaxiosPromise<Readable>;
        buffer(params?: Params$Resource$Projects$Locations$Queues$Tasks$Buffer, options?: MethodOptions): GaxiosPromise<Schema$BufferTaskResponse>;
