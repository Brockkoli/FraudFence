...
export declare namespace cloudresourcemanager_v3 {
    ...
    export class Resource$Effectivetags {
         ...
         */
        list(params: Params$Resource$Effectivetags$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Effectivetags$List, options?: MethodOptions): GaxiosPromise<Schema$ListEffectiveTagsResponse>;
    ...
    export class Resource$Tagvalues$Tagholds {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Tagvalues$Tagholds$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Tagvalues$Tagholds$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Tagvalues$Tagholds$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Tagvalues$Tagholds$Delete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Tagvalues$Tagholds$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Tagvalues$Tagholds$List, options?: MethodOptions): GaxiosPromise<Schema$ListTagHoldsResponse>;
